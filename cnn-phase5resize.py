...
plt.figure('Training_' + str(n_epochs) + 'epochs_' + str(nRUN) + 'RUNs_' + str(x_resize) + 'res_x_' + str(y_resize) + 'res_y')
...
# plt.show()
# save the plot in the Downloads folder (for Mac)
downloads_path = os.path.join(os.path.expanduser("~"), "Downloads")
plt.savefig(os.path.join(downloads_path, 'Training_' + str(n_epochs) + 'epochs_' + str(nRUN) + 'RUNs_' + str(x_resize) + 'res_x_' + str(y_resize) + 'res_y.png'))
