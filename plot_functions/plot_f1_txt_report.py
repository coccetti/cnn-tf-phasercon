# Description: This script reads a classification report file 
#              and plots the precision, recall, and F1-score for each class.

# Import the required libraries
import matplotlib.pyplot as plt
import re

def plot_classification_metrics(file_path):
    ...
    plt.plot(classes, precision_values, marker='o', linestyle='-', color='blue', label='Precision')
    plt.plot(classes, recall_values, marker='s', linestyle='--', color='red', label='Recall')
    plt.plot(classes, f1_score_values, marker='^', linestyle='-.', color='green', label='F1-Score')
    plt.xlabel('Classes')
    plt.ylabel('Score')
...
# # Example usage
# report_file_path = 'data_f1/classification_report_num_runs_64_250.txt'
# plot_classification_metrics(report_file_path)